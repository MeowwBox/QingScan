...
<main class="p-6 min-h-screen">
    <!-- 页面标题 -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-slate-800 mb-2">DirMap 目录扫描结果</h1>
        <nav class="flex gap-2 text-sm text-slate-500">
            ...
            <span class="text-slate-300">/</span>
            <span class="text-slate-700 font-medium">DirMap</span>
        </nav>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
        <div class="flex justify-between items-center px-5 py-4 border-b border-slate-100 bg-slate-50">
            <div class="flex items-center gap-3">
                <h2 class="text-lg font-bold text-slate-800">目录扫描结果</h2>
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-slate-50 border-b border-slate-200">
                        ...
                        <th class="px-5 py-4 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">状态码</th>
                        <th class="px-5 py-4 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">大小</th>
                        <th class="px-5 py-4 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">类型</th>
                ...
                <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="px-5 py-4 text-slate-600"><?php echo $value['size'] ?></td>
                    <td class="px-5 py-4">
                    ...
                    <td class="px-5 py-4 text-slate-700 max-w-xs truncate font-mono text-sm" title="<?php echo htmlspecialchars($value['url']) ?>"><?php echo $value['url'] ?></td>

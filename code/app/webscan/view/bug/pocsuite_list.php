...
<div class="flex justify-between items-start mb-6 p-6 pb-0">
    <div>
        <h1 class="text-2xl font-bold text-slate-800 mb-2">Pocsuite漏洞列表</h1>
        <nav class="flex gap-2 text-sm text-slate-500">
            ...
            <span class="text-slate-300">/</span>
            <span class="text-slate-700 font-medium">Pocsuite漏洞</span>
        </nav>
    </div>
</div>
        ...
        <table class="w-full">
            <thead>
                <tr class="bg-slate-50 border-b border-slate-100">
                    ...
                    <th class="px-5 py-4 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">CMS</th>
            ...
            <tbody class="divide-y divide-slate-100">
                <?php foreach ($list as $value) { ?>
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td class="px-5 py-4 text-slate-500 text-sm font-mono break-all max-w-xs"><?php echo $value['url'] ?></td>
                        <td class="px-5 py-4">

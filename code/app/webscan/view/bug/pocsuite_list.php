...
<div class="flex justify-between items-start mb-6 p-6 pb-0">
    <div>
        <h1 class="text-2xl font-bold text-text-primary mb-2">Pocsuite漏洞列表</h1>
        <nav class="flex gap-2 text-sm text-text-secondary">
            ...
            <span class="text-text-muted">/</span>
            <span class="text-text-primary font-medium">Pocsuite漏洞</span>
        </nav>
    </div>
</div>
...
<?php foreach ($list as $value) { ?>
    <tr class="hover:bg-surface-50 transition-colors">
        ...
        <td class="px-5 py-4 text-text-secondary text-sm font-mono break-all max-w-xs"><?php echo $value['url'] ?></td>
        <td class="px-5 py-4">

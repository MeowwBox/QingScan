...
<main class="p-6 min-h-screen">
    <!-- 页面标题 -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-slate-800 mb-2">VulMap 漏洞扫描</h1>
        <nav class="flex gap-2 text-sm text-slate-500">
            ...
            <span class="text-slate-300">/</span>
            <span class="text-slate-700 font-medium">VulMap</span>
        </nav>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
        <div class="flex justify-between items-center px-5 py-4 border-b border-slate-100 bg-slate-50">
            <div class="flex items-center gap-3">
                ...
                <span class="bg-red-500 text-white text-xs px-2.5 py-1 rounded-full font-medium"><?php echo count($list) ?? 0 ?></span>
            </div>
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-slate-50 border-b border-slate-200">
                        ...
                        <th class="px-5 py-4 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">APP</th>
                        <th class="px-5 py-4 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">Author</th>
                        <th class="px-5 py-4 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">Host</th>
                        <th class="px-5 py-4 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">Port</th>
                        <th class="px-5 py-4 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">URL</th>
                        <th class="px-5 py-4 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">Plugin</th>
                        <th class="px-5 py-4 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">Vuln Class</th>
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-5 py-4 text-slate-600"><?php echo $value['author'] ?></td>
                        <td class="px-5 py-4">
                        ...
                        <td class="px-5 py-4 max-w-xs truncate">
                            <span class="font-mono text-sm text-slate-600"><?php echo $value['url'] ?></span>
                        </td>
                        <td class="px-5 py-4">
                        ...
                        <td class="px-5 py-4 text-slate-500 text-sm"><?php echo date('Y-m-d H:i:s',$value['create_time']) ?></td>
                        <td class="px-5 py-4">

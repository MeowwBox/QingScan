...
<div class="flex justify-between items-start mb-6 p-6 pb-0">
    <div>
        <h1 class="text-2xl font-bold text-slate-800 mb-2">编辑关键字</h1>
        <nav class="flex gap-2 text-sm text-slate-500">
            ...
            <span class="text-slate-300">/</span>
            <span class="text-slate-700 font-medium">编辑</span>
        </nav>
    </div>
</div>
    ...
    <form method="post" action="" class="p-6">
        ...
        <div class="space-y-5">
            <div>
                ...
                <input type="text" name="title" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-700 placeholder-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none transition-all" value="<?php echo $info['title']?>">
            </div>
        </div>

...
<div class="max-w-2xl mx-auto py-8">
    <div class="bg-white border border-slate-200 rounded-2xl shadow-card p-8">
        <div class="mb-6">
            ...
            <p class="text-slate-500 text-sm mt-1">配置URL扫描任务参数</p>
        </div>
        <form method="post" action="<?php echo url('urls/_add')?>">
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <textarea class="w-full bg-slate-50 border border-slate-300 rounded-xl px-4 py-3 text-slate-800 placeholder-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none transition-all resize-none" rows="3" placeholder="填写header消息" name="header"></textarea>
                </div>
                <div>
            ...
            <div class="flex gap-3 mt-8">
                ...
                <a href="<?php echo url('urls/index')?>" class="px-6 py-2.5 rounded-xl border border-slate-300 text-slate-700 font-medium hover:bg-slate-50 transition-all duration-200">返回</a>
            </div>
        </form>
    </div>
</div>

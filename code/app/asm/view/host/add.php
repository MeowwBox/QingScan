...
<div class="max-w-2xl mx-auto py-8">
    <div class="bg-white border border-slate-200 rounded-2xl shadow-card p-8">
        <div class="mb-6">
            ...
            <p class="text-slate-500 text-sm mt-1">配置主机扫描任务参数</p>
        </div>
        <form method="post" action="/index.php?s=host/_add">
            <div class="space-y-5">
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-2">所属应用</label>
            ...
            <div class="flex gap-3 mt-8">
                ...
                <a href="/index.php?s=host/index" class="px-6 py-2.5 rounded-xl border border-slate-300 text-slate-700 font-medium hover:bg-slate-50 transition-all duration-200">返回</a>
            </div>
        </form>
    </div>
</div>

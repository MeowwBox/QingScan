...
<!-- 表格区域 -->
<div class="bg-white border border-surface-300 rounded-2xl overflow-hidden shadow-card opacity-0 animate-fadeIn delay-400">
    <!-- 表头 -->
    <div class="flex justify-between items-center px-5 py-4 border-b border-surface-200 bg-surface-50">
        <div class="flex items-center gap-3">
            <h2 class="text-lg font-bold text-text-primary">域名列表</h2>
        ...
        <table class="w-full">
            <thead>
                <tr class="bg-surface-100">
                    ...
                    <th class="px-5 py-4 text-left text-xs font-semibold text-text-secondary uppercase tracking-wider">主体信息</th>
            ...
            <tbody class="divide-y divide-surface-200">
                ...
                <tr class="hover:bg-surface-50 transition-colors">
                    ...
                    <td class="px-5 py-4">
                        <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-blue-50 text-blue-600 border border-blue-100 font-mono">
                            <?php echo htmlspecialchars($value['host']) ?>
                        </span>
                    </td>
                    <td class="px-5 py-4">
    ...
    <div class="flex justify-between items-center px-5 py-4 border-t border-surface-200 bg-surface-50">
        <div class="text-sm text-text-secondary">
            共 <span class="text-text-primary font-semibold"><?php echo $total ?? count($list); ?></span> 条记录
        </div>
        <div class="flex gap-1">
            {$page|raw}
        </div>

...
<!-- 页面标题 -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-text-primary mb-2">Hooks 提交记录</h1>
            <nav class="flex gap-2 text-sm text-text-secondary">
                ...
                <span class="text-text-primary font-medium">Hooks 提交记录</span>
            </nav>
        </div>
        ...
        <div class="bg-white border border-surface-300 rounded-2xl overflow-hidden shadow-card">
            ...
            <div class="flex justify-between items-center px-6 py-4 border-b border-surface-200 bg-surface-50">
                <div class="flex items-center gap-3">
                    <h2 class="text-lg font-bold text-text-primary">提交记录</h2>
                        ...
                        <tr class="hover:bg-surface-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex gap-1">
                                    ...
                                    <a href="#" class="w-9 h-9 rounded-xl bg-surface-100 text-red-500 hover:bg-red-50 transition-colors flex items-center justify-center" title="删除">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">

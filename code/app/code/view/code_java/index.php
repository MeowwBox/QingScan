...
<div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
    <div class="px-5 py-4 border-b border-slate-100 bg-slate-50">
        <div class="flex items-center justify-between">
            <h3 class="text-lg font-semibold text-slate-800">Java依赖列表</h3>
        </div>
    </div>
    <div class="p-5">
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-slate-50">
                        ...
                        <th class="px-4 py-3 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">modelVersion</th>
                        <th class="px-4 py-3 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">groupId</th>
                        <th class="px-4 py-3 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">artifactId</th>
                ...
                <tbody class="divide-y divide-slate-100">
                    <?php foreach ($list as $value) { ?>
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-slate-600"><?php echo $value['modelVersion'] ?></td>
                            <td class="px-4 py-3 text-slate-600"><?php echo $value['groupId'] ?></td>
                            <td class="px-4 py-3 text-slate-600"><?php echo $value['artifactId'] ?></td>

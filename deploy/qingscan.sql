...
(
  ...
  AUTO_INCREMENT = 2613
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '权限列表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  AUTO_INCREMENT = 1166
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '自定义插件扫描结果'
  ROW_FORMAT = COMPACT;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '代理表'
  ROW_FORMAT = COMPACT;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '自定义插件'
  ROW_FORMAT = COMPACT;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = 'github关键字监控结果'
  ROW_FORMAT = COMPACT;
...
(
  ...
  AUTO_INCREMENT = 98
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = 'github关键字设置'
  ROW_FORMAT = COMPACT;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '本地代理'
  ROW_FORMAT = COMPACT;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = 'web指纹识别'
  ROW_FORMAT = COMPACT;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = 'waf指纹识别'
  ROW_FORMAT = COMPACT;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '漏洞扫描'
  ROW_FORMAT = COMPACT;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = 'url收集'
  ROW_FORMAT = COMPACT;
...
(
  ...
  AUTO_INCREMENT = 16
  CHARACTER SET = utf8mb4 COMMENT = '自动发现资产'
  ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for asm_cloud_huoshan
-- ----------------------------
-- 先检查并删除表（如果存在）
CREATE TABLE IF NOT EXISTS `asm_cloud_huoshan`
(
    `id`            int(11)                                                       NOT NULL AUTO_INCREMENT COMMENT '自增主键',
    ...
    `region`        varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL     DEFAULT NULL COMMENT '地域',
    `status`        varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL     DEFAULT NULL COMMENT '资源状态',
    `public_ip`     varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL     DEFAULT NULL COMMENT '公网IP',
    `private_ip`    varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL     DEFAULT NULL COMMENT '私网IP',
...
-- 先检查并删除表（如果存在）
CREATE TABLE IF NOT EXISTS `asm_cloud_tianyi`
(
    `id`            int(11)                                                       NOT NULL AUTO_INCREMENT COMMENT '自增主键',
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '主机资产总表'
  ROW_FORMAT = Dynamic;

CREATE TABLE IF NOT EXISTS `asm_cloud_yidong`
(
    `id`            int(11)                                 NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `resource_id`   varchar(100) COLLATE utf8mb4_general_ci NOT NULL COMMENT '资源ID',
    ...
    `region`        varchar(50) COLLATE utf8mb4_general_ci           DEFAULT '' COMMENT '区域',
    `status`        varchar(50) COLLATE utf8mb4_general_ci           DEFAULT '' COMMENT '状态',
    `public_ip`     varchar(100) COLLATE utf8mb4_general_ci          DEFAULT '' COMMENT '公网IP',
    `private_ip`    varchar(100) COLLATE utf8mb4_general_ci          DEFAULT '' COMMENT '内网IP',
    `public_ips`    text COLLATE utf8mb4_general_ci COMMENT '公网IP列表',
    `private_ips`   text COLLATE utf8mb4_general_ci COMMENT '内网IP列表',
    `create_time`   datetime                                NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `update_time`   datetime                                NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
